...
public class CustomRadioGroup extends LinearLayout {
    ...
    private static final int TEXT_START_COLOR = Color.GRAY, END_COLOR = Color
            .parseColor("#167ee9"), TEXT_START_R = Color.red(TEXT_START_COLOR),
            TEXT_START_G = Color.green(TEXT_START_COLOR), TEXT_START_B = Color
            .blue(TEXT_START_COLOR), TEXT_DIF_R = Color.red(END_COLOR)
            - TEXT_START_R, TEXT_DIF_G = Color.green(END_COLOR)
            - TEXT_START_G, TEXT_DIF_B = Color.blue(END_COLOR)
            - TEXT_START_B;
    // 条目变更监听
    ...
    public void addItem(int unSelected, int selected, String text) {
        ...
        rb.v.setOnClickListener(arg0 -> setCheckedIndex(i));
        addView(rb.v);
        lists.add(rb);
    }
    ...
    private class RadioButton {
        ...
        RadioButton(int unSelected, int selected, String string) {
            // 相关的资源ID：
            int ID_LAYOUT = R.layout.custom_radio_button;
            v = inflater.inflate(ID_LAYOUT, null);
            int ID_IMAGE_TOP = R.id.custom_radio_button_image_top;
            top = v.findViewById(ID_IMAGE_TOP);
            int ID_IMAGE_BOTTOM = R.id.custom_radio_button_image_botom;
            bottom = v.findViewById(ID_IMAGE_BOTTOM);
            int ID_TEXT = R.id.custom_radio_button_text;
            text = v.findViewById(ID_TEXT);
            int ID_NEWS = R.id.custom_radio_button_news;
            news = v.findViewById(ID_NEWS);
