...
import com.caspar.base.dialog.ShowDialogUtil
...
abstract class BaseActivity<SV : ViewBinding> : AppCompatActivity(), ToastAction {
    ...
    fun showDialog() {
        ShowDialogUtil.showSearchDialog(this)
    }

    fun stopDialog() {
        ShowDialogUtil.stopDialog()
    }
    ...
    override fun attachBaseContext(newBase: Context?) {
        super.attachBaseContext(newBase?.let { SwitchLanguageUtils().getAttachBaseContext(it) })
